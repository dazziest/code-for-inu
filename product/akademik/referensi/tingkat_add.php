...
if (isset($_REQUEST['Simpan'])) {
	OpenDb();
	$sql = "SELECT * FROM tingkat WHERE tingkat = '$tingkat'";
	$result = QueryDb($sql);
...
<title>AKADEMIK [Tambah Tingkat]</title>
...
<tr>
    ...
    <td><input type="text" class="disabled"  name="departemen" size="30" value="<?=$departemen ?>" readonly/><input type="hidden" name="departemen" id="departemen" value ="<?=$departemen ?>" /></td>
</tr>
<tr>
