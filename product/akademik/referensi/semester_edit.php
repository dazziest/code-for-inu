...
<title>AKADEMIK [Ubah Semester]</title>
...
<tr>
	...
	<td><input type="text" size="30" value="<?=$departemen ?>" readonly class="disabled"/></strong><input type="hidden" name="departemen" id="departemen" value="<?=$departemen ?>" />
    </td>
</tr>
<tr>
