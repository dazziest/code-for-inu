...
function setaktif(replid, aktif) {
	...
	if (aktif == 1) {
		msg = "Apakah anda yakin akan mengubah sekolah ini menjadi TIDAK AKTIF?";
		newaktif = 0;
	} else	{	
		msg = "Apakah anda yakin akan mengubah sekolah ini menjadi AKTIF?";
		newaktif = 1;
	}
...
<tr height="300">
  <td align="left" valign="top">
    ...
    <tr>
        <td align="right">&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Sekolah</font></td>
    </tr>
    <tr>
        <td align="right"><a href="../referensi.php" target="content">
          <font size="1" face="Verdana" color="#000000"><b>Referensi</b></font></a>&nbsp>&nbsp <font size="1" face="Verdana" color="#000000"><b>Sekolah</b></font>
        </td>
    </tr>
     <tr>
      <td align="left">&nbsp;</td>
	...
	<br /><br />
    <?
	$sql = "SELECT d.replid,d.departemen,d.nipkepsek,p.nama,d.keterangan,d.aktif FROM departemen d, jbssdm.pegawai p WHERE d.nipkepsek = p.nip ORDER BY d.urutan";
	//echo $sql;    
	$result = QueryDb($sql);
...
<?	if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
	    <a href="JavaScript:tambah()"><img src="../images/ico/tambah.png" border="0" onMouseOver="showhint('Tambah!', this, event, '50px')" />&nbsp;Tambah Sekolah</a>
<?	} ?>    
    </td></tr>
    </table><br />
    ...
    <tr height="30">
        ...
        <td width="15%" class="header" align="center">Sekolah</td>
...
<?		if (SI_USER_LEVEL() != $SI_USER_STAFF) {  ?>         
		<td align="center">
            <a href="JavaScript:edit(<?=$row[0] ?>)"><img src="../images/ico/ubah.png" border="0" onMouseOver="showhint('Ubah sekolah!', this, event, '80px')" /></a>&nbsp;
            <a href="JavaScript:hapus(<?=$row[0] ?>)"><img src="../images/ico/hapus.png" border="0" onMouseOver="showhint('Hapus sekolah!', this, event, '80px')"/></a>
        </td>
<?		} ?>  
    </tr>
<?	} ?>
