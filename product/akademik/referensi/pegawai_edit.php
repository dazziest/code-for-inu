...
if (isset($_REQUEST['simpan'])) {
	...
	if($num_cek > 0) {
		...
		$query = "UPDATE jbssdm.pegawai SET nip='$nip', nama='$nama', gelar='$gelar', panggilan='$panggilan', tmplahir='$tempatlahir', tgllahir='$lahir', agama='$agama', suku='$suku',nikah='$menikah', noid='$identitas',alamat='$alamat',telpon='$telpon',handphone='$handphone',email='$email', bagian='$bagian', keterangan='$keterangan', kelamin='$kelamin' $gantifoto WHERE replid = $replid ";
...
<title>AKADEMIK [Ubah Pegawai]</title>
...
<tr height="150">
    ...
    <tr>
        ...
        <tr>
            ...
            <img src="../library/gambar.php?replid=<?=$replid?>&table=jbssdm.pegawai"  border="0"/>
            </td>
       	</tr>
        </table>
        </td>
