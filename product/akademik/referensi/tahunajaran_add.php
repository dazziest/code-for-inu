...
<title>AKADEMIK [Tambah Tahun Ajaran]</title>
...
function validate(){	
	...
	action = "add";
	opener.location.href = "tahunajaran.php?departemen="+departemen+"&tahunajaran="+ajaran+"&tglmulai="+tglmulai+"&tglakhir="+tglakhir+"&keterangan="+keterangan+"&action="+action;
	window.close();
}
...
<tr>
	...
	<td colspan="2">
    	<input  class="disabled" type="text" name="departemen" id="departemen" readonly="readonly" size="30" maxlength="50" value="<?=$departemen ?>" />    </td>
</tr>
<tr>
