...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysql_num_rows($result) > 0) {		
		CloseDb();
		$ERROR_MSG = "Sekolah $departemen sudah digunakan!";	
		$cek = 0;	
...
<title>AKADEMIK [Tambah Sekolah]</title>
...
function validate() {
	return validateEmptyText('departemen', 'Nama Departemen') && 
		   validateEmptyText('nip', 'NIP dan Nama Kepala Sekolah') && 
...
<tr>
	...
	<td>
    	<input type="text" name="departemen" id="departemen" size="30" maxlength="50" value="<?=$departemen ?>" onFocus="showhint('Nama sekolah tidak boleh lebih dari 50 karakter!', this, event, '120px');panggil('departemen')" onKeyPress="return focusNext('nip', event)"/></td>
</tr>
<tr>
    ...
    <td><input type="text" class="disabled" name="nip" id="nip" size="10" value="<?=$nipkepsek ?>" readonly onClick="caripegawai()" onKeyPress="caripegawai();" onFocus="panggil('nip')"/>
    	<input type="hidden" name="nipkepsek" id="nipkepsek" value="<?=$nipkepsek ?>"/>
      <input type="text" class="disabled" name="nama" id="nama" size="25" value="<?=$namakepsek ?>"   readonly onClick="caripegawai()" onFocus="panggil('nama')"/>&nbsp;
...
<tr>
	...
	<td>
    	<input type="text" name="urutan" id="urutan" size="3" maxlength="5" value="<?=$urutan ?>" onFocus="showhint('Urutan penampilan sekolah', this, event, '120px');panggil('urutan')" onKeyPress="return focusNext('keterangan', event)"/>    </td>
</tr>
<tr>
