...
if ($op == "delheader") {
	...
	if ($row[0] != '')
		$sql = "UPDATE jbsumum.identitas SET nama=NULL, situs=NULL, email=NULL, alamat1=NULL, alamat2=NULL, telp1=NULL, telp2=NULL, telp3=NULL, telp4=NULL, fax1=NULL, fax2=NULL WHERE departemen = '$departemen'";
	else
