...
<title>AKADEMIK [Ubah Tahun Ajaran]</title>
...
<tr>
	...
	<td colspan="2">
    	<input type="text" class="disabled" name="departemen" id="departemen" size="30" maxlength="50" value="<?=$departemen ?>" readonly="readonly" />    </td>
</tr>
<tr>
