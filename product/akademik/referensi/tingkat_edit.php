...
if (isset($_REQUEST['Simpan'])) {
	...
	$sql = "SELECT * FROM tingkat WHERE tingkat = '$_REQUEST[tingkat]' AND replid <> $replid";
	$result = QueryDb($sql);
...
<title>AKADEMIK [Ubah Tingkat]</title>
...
<tr>
	...
	<td><input type="text" size="30" value="<?=$departemen ?>" class="disabled" readonly/>
