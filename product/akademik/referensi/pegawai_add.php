...
if (isset($_REQUEST['simpan'])) {
	...
	if (strlen($uploadedfile)!=0){
		...
		ResizeImage($foto, 159, 120, 70, $filename);
	...
	if($num_cek > 0) {
		...
		$query = "INSERT INTO jbssdm.pegawai SET nip='$nip', nama='$nama', gelar='$gelar', panggilan='$panggilan', tmplahir='$tempatlahir', tgllahir='$lahir', agama='$agama', suku='$suku',nikah='$menikah', noid='$identitas',alamat='$alamat',telpon='$telpon',handphone='$handphone',email='$email', bagian='$bagian', keterangan='$keterangan', aktif='1', kelamin='$kelamin', pinpegawai='$pin' $gantifoto";
...
<title>AKADEMIK [Tambah Pegawai]</title>
...
<tr height="150">
   ...
   <tr>
       	<td>Menikah</td>
       	<td colspan="2">
            <input type="radio" id="menikah"  name="menikah" value="menikah" <? if ($menikah == 'menikah') echo 'checked';?>  onKeyPress="return focusNext('identitas', event)" />&nbsp;Sudah&nbsp;
            <input type="radio" id="menikah"  name="menikah" value="belum" <? if ($menikah == 'belum') echo 'checked';?>  onKeyPress="return focusNext('identitas', event)"/>&nbsp;Belum&nbsp;
	        <input name="menikah" type="radio" id="menikah" value="tak_ada" <? if ($menikah == 'tak_ada' || $menikah =="") echo 'checked';?>  onKeyPress="return focusNext('identitas', event)"/>&nbsp;(Tidak ada data)            </td>
   </tr>
   <tr>
      	<td>No. Identitas</td>
