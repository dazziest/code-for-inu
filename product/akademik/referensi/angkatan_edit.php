...
if (isset($_REQUEST['Simpan'])) {
	OpenDb();
	$angkatan=trim($_REQUEST[angkatan]);
	...
	if (@mysql_num_rows($result) > 0) {
		...
		$sql = "UPDATE angkatan SET angkatan='$_REQUEST[angkatan]',keterangan='$_REQUEST[keterangan]' WHERE replid=$replid";
		$result = QueryDb($sql);
		CloseDb();
...
<title>AKADEMIK [Ubah Angkatan]</title>
...
<tr>
	...
	<td><input type="text" size="30" value="<?=$departemen ?>" readonly class="disabled"/>
