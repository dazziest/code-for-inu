...
<title>AKADEMIK [Ubah Aturan Penentuan Grading Nilai]</title>
...
<fieldset><legend><b>Aturan Grading</b></legend>
	...
	<table border="0" width="100%"  id="table" class="tab">
		...
		<tr height="25">
			...
			<td align="right"><input type="text" name=<?='nmin'.$cnt?> id=<?='nmin'.$cnt?> size="8" maxlength="5" value="<?=$nmin[$cnt]?>" onKeyPress="focusNext('nmax<?=$cnt?>',event)"> </td>
