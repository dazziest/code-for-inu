...
function tambah() {
	...
	newWindow('jenis_pengujian_add.php?preplid='+preplid+'&nama_pel='+nama_pel+'&nama_dep='+nama_dep, 'TambahJennisPengujian','510','315','resizable=1,scrollbars=1,status=0,toolbar=0')
}
...
function edit(replid) {
	newWindow('jenis_pengujian_edit.php?replid='+replid, 'UbahJenisPengujian','510','315','resizable=1,scrollbars=1,status=1,toolbar=0')
}
