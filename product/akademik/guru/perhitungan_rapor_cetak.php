...
OpenDb();
$sql = "SELECT j.departemen, j.nama, p.nip, p.nama FROM guru g, jbssdm.pegawai p, pelajaran j WHERE g.nip=p.nip AND g.idpelajaran = j.replid AND j.replid = $id_pelajaran AND g.nip = '$nip'"; 
...
<title>AKADEMIK [Cetak Perhitungan Nilai Rapor]</title>
</head>
<body>
<center>
