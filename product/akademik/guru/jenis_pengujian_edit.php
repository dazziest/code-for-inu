...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysql_num_rows($result) > 0) {
		...
		$sql = "UPDATE jenisujian SET replid=$_REQUEST[replid],jenisujian='$_REQUEST[jenisujianbaru]',info1='$_REQUEST[singkatan]',keterangan='$_REQUEST[keterangan]' WHERE jenisujian='$_REQUEST[jenisujian]' AND replid=$_REQUEST[replid]";
		$result = QueryDb($sql);
		CloseDb();
...
<title>Akademik [Ubah Jenis Pengujian]</title>
...
<tr>
  ...
  <td><input type="text" name="departemen" id="departemen" size="30" maxlength="30" value="<?=$departemen ?>"  class="disabled" readonly/></td>
</tr>
<tr>
