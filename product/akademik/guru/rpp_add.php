...
<title>AKADEMIK [Tambah Rencana Program Pembelajaran]</title>
...
<!-- TABLE CONTENT -->
<tr>
	<td width="12%"><strong>Sekolah</strong></td>
	<td width="12%">
    	<input type="text" name="departemen1" id="departemen1" size="30" readonly value="<?=$departemen ?>" class="disabled" />
