...
<table id="Table_01" width="453" height="319" border="0" cellpadding="0" cellspacing="0" align="left">
	...
	<tr>
		...
		<td colspan="3">
			<img src="images_slice/kelulusan_03.gif" alt="" width="70" height="117" border="0" onClick="alert ('Untuk mendata Sekolah, Tahun Ajaran Baru, Angkatan Baru, dan Kelas Baru \nSilakan lakukan di Bagian Referensi');" style="cursor:pointer"></td>
		<td colspan="3">
	...
	<tr>
		...
		<td colspan="3">
			<a href="siswa/siswa_lulus_main.php"  onMouseOver="showhint('Pendataan Kelulusan Siswa', this, event, '100px')">
