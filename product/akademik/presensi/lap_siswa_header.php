...
<tr>
    ...
    <tr>
        ...
        <td colspan="4"><input type="text" name="nis" id="nis" size="12" readonly class="disabled" value="<?=$_REQUEST['nis']?>" onclick="carisiswa()"/>
    ...
    <td rowspan="2" align="left" valign="middle" width="*"><a href="#" onclick="tampil()"><img src="../images/view.png" onmouseover="showhint('Klik untuk menampilkan laporan presensi siswa!', this, event, '150px')" height="48" border="0" name="tabel" id="tabel2"/></a></td>
