...
function cetak() {
	...
	newWindow('lap_harianabsen_cetak.php?tglawal='+tglawal+'&tglakhir='+tglakhir+'&semester='+semester+'&kelas='+kelas+'&tingkat='+tingkat+'&departemen='+departemen+'&urut=<?=$urut?>&urutan=<?=$urutan?>', 'CetakLaporanHarianDataSiswayangTidakHadir','800','650','resizable=1,scrollbars=1,status=0,toolbar=0');
}
...
function excel() {
	...
	newWindow('lap_harianabsen_excel.php?tglawal='+tglawal+'&tglakhir='+tglakhir+'&semester='+semester+'&kelas='+kelas+'&tingkat='+tingkat+'&departemen='+departemen+'&urut=<?=$urut?>&urutan=<?=$urutan?>', 'CetakLaporanHarianDataSiswayangTidakHadir','800','650','resizable=1,scrollbars=1,status=0,toolbar=0');
}
