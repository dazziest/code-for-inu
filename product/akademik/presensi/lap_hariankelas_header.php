...
<title>Akademik [Laporan Presensi Harian Siswa Per Kelas]</title>
...
<tr>	
    ...
    <td width="*" rowspan="3" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Klik untuk menampilkan laporan presensi harian per kelas!', this, event, '100px')" height="48" width="48" border="0" name="tabel" id="tabel"/></a></td>
