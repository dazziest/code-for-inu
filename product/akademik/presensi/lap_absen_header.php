...
<title>Laporan Data Siswa yang Tidak Hadir</title>
...
function tampil() {
	...
	if (validasi) 	
		parent.footer.location.href = "lap_absen_footer.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&semester="+semester+"&kelas="+kelas+"&tingkat="+tingkat+"&departemen="+departemen;
}
...
function change() {
	...
	parent.header.location.href = "lap_absen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran+"&kelas="+kelas+"&tingkat="+tingkat;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php";	
}
...
function change_dep() {
	...
	parent.header.location.href = "lap_absen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php";	
}
...
function change_ajaran() {
	...
	parent.header.location.href = "lap_absen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php";	
}
...
function change_tingkat() {
	...
	parent.header.location.href = "lap_absen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran+"&tingkat="+tingkat;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php";	
}
...
function panggil(elem){
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php";
	var lain = new Array('departemen','tahunajaran','tingkat','semester','kelas','tgl1','bln1','th1','tgl2','bln2','th2');
...
<form action="lap_harianabsen_header.php" method="post" name="main">
...
<tr>
	...
	<?	} ?>
         ...
         <td width="12%"><strong>Tingkat </strong></td>
		  ...
		  <?	OpenDb();
			$sql = "SELECT replid,tingkat FROM tingkat WHERE departemen='$departemen' ORDER BY urutan";	
			$result = QueryDb($sql);
			CloseDb();
	...
	<td width="*" rowspan="4" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Klik untuk menampilkan laporan harian data siswa yang tidak hadir!', this, event, '180px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
        ...
        Data Siswa yang Tidak Hadir</font><br />
    <a href="../presensi.php?page=pp" target="content">
      <font size="1" color="#000000"><b>Presensi</b></font></a>&nbsp>&nbsp
        <font size="1" color="#000000"><b>Laporan Data Siswa yang Tidak Hadir</b></font>
        </td>   
    </td>
</tr>
