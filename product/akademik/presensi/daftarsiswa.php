...
<tr>
	...
	Sekolah: <strong><input type="text" name="departemen" id="departemen" value="<?=$departemen ?>" size="10" readonly 	style="background-color:#CCCCCC" /></strong>
...
<tr>
    ...
    <input type="button" name="pilih" class="but" id="pilih" value="Pilih" onclick="pilihan('<?=$row[0]?>','<?=$row[1]?>','<?=$cnt?>')" />
