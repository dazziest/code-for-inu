...
function tampil() {
	...
	if (validasi)		
		parent.footer.location.href = "lap_harianabsen_footer.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&semester="+semester+"&kelas="+kelas+"&tingkat="+tingkat+"&departemen="+departemen;
}
...
function change() {
	...
	parent.header.location.href = "lap_harianabsen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran+"&kelas="+kelas+"&tingkat="+tingkat;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php?tipe='harian'";	
}
...
function change_dep() {
	...
	parent.header.location.href = "lap_harianabsen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php?tipe='harian'";	
}
...
function change_ajaran() {
	...
	parent.header.location.href = "lap_harianabsen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php?tipe='harian'";	
}
...
function change_tingkat() {
	...
	parent.header.location.href = "lap_harianabsen_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&semester="+semester+"&tahunajaran="+tahunajaran+"&tingkat="+tingkat;	
	parent.footer.location.href = "blank_presensi_siswa_tidak_hadir.php?tipe='harian'";	
}
        ...
        <? 	if ($tahunajaran <> "") { 
		 ...
		 ?> 
            ...
            <?	} ?>
                ...
                <td width="160">
                <select name="bln1" id ="bln1" onchange="change_tgl1()" onKeyPress="focusNext('th1',event)" onfocus="panggil('bln1')">
            <? 	for ($i=1;$i<=12;$i++) { ?>
                <option value="<?=$i?>" <?=IntIsSelected($bln1, $i)?>><?=$bulan[$i]?></option>	
            <?	}	?>	
                </select>
                <select name="th1" id = "th1" onchange="change_tgl1()" onKeyPress="focusNext('tgl2',event)" onfocus="panggil('th1')" style="width:60px">
            ...
            <? 	for($i=1;$i<=$n2;$i++){   ?>      
                ...
                <td>
                <select name="bln2" id ="bln2" onchange="change_tgl2()" onKeyPress="focusNext('th2',event)" onfocus="panggil('bln2')">
            <? 	for ($i=1;$i<=12;$i++) { ?>
