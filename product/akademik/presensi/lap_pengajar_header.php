...
function change_departemen() {
	...
	parent.header.location.href = "lap_pengajar_header.php?tgl1="+tgl1+"&bln1="+bln1+"&th1="+th1+"&tgl2="+tgl2+"&bln2="+bln2+"&th2="+th2+"&departemen="+departemen+"&nip="+nip+"&nama="+nama;	
...
<tr>	
	...
	<tr>
    	<td width="20%"><strong>Guru</strong></td>
        <td colspan="4"><strong>
    		...
    		<input name="nama" type="text" class="disabled" id="nama" value="<?=$_REQUEST['nama'] ?>" size="35" readonly onclick="pegawai();"/>
    ...
    <td width="*" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Klik untuk menampilkan laporan presensi pengajar!', this, event, '180px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
