...
<title>Akademik [Cetak Laporan Presensi Pengajar]</title>
<style type="text/css">
<!--
.style1 {
	font-size: 16px;
...
<table width="27%">
<tr>
	<td width="43%"><span class="style4">Sekolah</span></td>
...
<tr>
    ...
    <td colspan="7"><span class="style4">: <? if ($tingkat == -1) echo "Semua Tingkat"; else echo $row['tingkat']; ?></strong></td>
</tr>
<tr>
	<td><span class="style4">Kelas</strong></td>
    <td colspan="7"><span class="style4">: <? if ($kelas == -1) echo "Semua Kelas"; else echo $row['kelas']; ?></strong></td>
</tr>
<tr>
	<td><span class="style4">Pelajaran</strong></td>
    <td colspan="7"><span class="style4">: <? if ($pelajaran == -1) echo "Semua Pelajaran"; else echo $row['nama']; ?></strong></td>
</tr>
<tr>
