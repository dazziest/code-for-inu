...
<tr>
	...
	<tr>
        ...
        <?
            $query_k = "SELECT k.replid, k.kelas FROM jbsakad.kelas k, jbsakad.tahunajaran a WHERE k.idtingkat = '$tingkat' AND k.aktif = 1 AND k.idtahunajaran = a.replid AND a.departemen = '$departemen' AND a.aktif = 1";
			//echo $query_k;
    ...
    <td align="left" valign="middle" width="*" rowspan="2">
    	<img src="../images/view.png" width="48" height="48" border="0" onClick="show()" style="cursor:pointer;" OnMouseOver="showhint('Klik untuk menampilkan rata-rata ujian kelas!', this, event, '150px')">            </td>
    ...
    <a href="../penilaian.php" target="content"> <font size="1" color="#000000"><b>Penilaian</b></font></a>&nbsp>&nbsp <font size="1" color="#000000"><b>Rata-rata RPP Setiap Siswa</b></font>
    </td>
</tr>	
</table>
</form>
