...
OpenDb();
$query = "SELECT DISTINCT u.idaturan, u.idkelas, u.idsemester, s.nama FROM jbsakad.ujian u, jbsakad.siswa s WHERE u.replid = $idujian AND s.nis = '$nis'";
...
if(isset($_REQUEST['ubah'])) {
	$query_isi_nilai = "INSERT INTO jbsakad.nilaiujian SET nis='$nis', idujian=$idujian, keterangan='$keterangan', nilaiujian='$nilai'";
	$result_isi_nilai = QueryDb($query_isi_nilai);
...
<html>
<head>
<title>Akademik [Tambah Data Nilai Ujian]</title>
