...
//echo "Dep=".$departemen.", Tkt=".$tingkat.", Kls=".$kelas.", Pelajaran=".$pelajaran.", Semester=".$semester.", Thn AJaran=".$tahun;
	...
	*/
	...
	//$row_get_siswa=@mysql_fetch_array($result_get_siswa);
	CloseDb();
	OpenDb();
	...
	CloseDb();
	//$row_get_siswa=@mysql_fetch_array($result_get_siswa1);
...
<table width="100%" border="0">
  ...
  <tr height="20">
    <td width="20%"><span class="style13"><strong>Sekolah</strong></span></td>
  ...
  <tr>
    ...
    <table width="100%" border="1" bordercolor="#FFFFFF" class="tab" id="table" cellspacing="0" cellpadding="0">
  <tr>
    <td width="27%" rowspan="2" bgcolor="#CCCCCC" class="headerlong" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Pelajaran</strong></font></td>
    <td width="14%" rowspan="2" bgcolor="#CCCCCC" class="headerlong" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Standar Kelulusan</strong></font></td>
    <td width="18%" colspan="2" bgcolor="#CCCCCC" class="headerlong" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Nilai Pemahaman Konsep</strong></font></td>
    <td width="19%" colspan="2" bgcolor="#CCCCCC" class="headerlong" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Nilai Praktik</strong></font></td>
    <td width="23%" rowspan="2" bgcolor="#CCCCCC" class="headerlong" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Predikat</strong></font></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC" class="header" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Angka</strong></font></td>
    <td bgcolor="#CCCCCC" class="header" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Huruf</strong></font></td>
    <td bgcolor="#CCCCCC" class="header" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Angka</strong></font></td>
    <td bgcolor="#CCCCCC" class="header" align="center"><font face="Verdana" size="2" color="#000000" ><strong>Huruf</strong></font></td>
    </tr>
	<?
	OpenDb();
	$sql_get_pelajaran_laporan="SELECT pel.replid as replid,pel.nama as nama FROM jbsakad.ujian uji, jbsakad.nilaiujian niluji, jbsakad.siswa sis, jbsakad.pelajaran pel WHERE uji.replid=niluji.idujian AND niluji.nis=sis.nis AND uji.idpelajaran=pel.replid AND uji.idsemester=$semester AND uji.idkelas=$kelas AND sis.nis='$nis' GROUP BY pel.nama";
	...
	while ($row_get_pelajaran_laporan=@mysql_fetch_array($result_get_pelajaran_laporan)){
		...
		$sql_get_nap_PK="SELECT n.nilaiangka as nilaiangka,n.nilaihuruf as nilaihuruf FROM jbsakad.nap n, jbsakad.aturannhb a WHERE n.idinfo='$row_get_infonap[replid]' AND n.idaturan=a.replid AND n.nis='$row_siswa1[nis]' AND a.dasarpenilaian='Pemahaman Konsep'";
		$result_get_nap_PK=QueryDb($sql_get_nap_PK);
		$row_get_nap_PK=@mysql_fetch_array($result_get_nap_PK);
		//get value from nap praktik
		$sql_get_nap_P="SELECT n.nilaiangka as nilaiangka,n.nilaihuruf as nilaihuruf FROM jbsakad.nap n, jbsakad.aturannhb a WHERE n.idinfo='$row_get_infonap[replid]' AND n.idaturan=a.replid AND n.nis='$row_siswa1[nis]' AND a.dasarpenilaian='Praktik'";
		$result_get_nap_P=QueryDb($sql_get_nap_P);
		$row_get_nap_P=@mysql_fetch_array($result_get_nap_P);
	?>
  <tr>
    <td height="25"><span class="style13"><?=$row_get_pelajaran_laporan[nama]?></span>
					<!--<input type="hidden" name="replid_pel_laporan" id="replid_pel_laporan" value="<?=$row_get_pelajaran_laporan[replid]?>">-->	</td>
    <td height="25" align="center"><span class="style13"><?=$row_get_infonap[nilaimin]?></span></td>
    <!-- Biar ada merahnya -->
	<?
	if ((int)$row_get_nap_PK[nilaiangka]!=0){
		if ($row_get_nap_PK[nilaiangka]<$row_get_infonap[nilaimin]){
		?>
			<td height="25" align="center"><font color="red"><span class="style13"><?=$row_get_nap_PK[nilaiangka]?></span></font><br></td>
		<?
		} else {
		?>
			<td height="25" align="center"><span class="style13"><?=$row_get_nap_PK[nilaiangka]?></span><br></td>
		<?
		}
	} else {
	?>
		<td height="25" align="center"> - <br></td>
	<?
	}
	?>
	<td height="25" align="center"><span class="style13"><?=$row_get_nap_PK[nilaihuruf]?></span></td>
    <!-- Biar ada merahnya -->
	<?
	if ((int)$row_get_nap_P[nilaiangka]!=0){
		if ($row_get_nap_P[nilaiangka]<$row_get_infonap[nilaimin]){
		?>
			<td height="25" align="center"><font color="red"><span class="style13"><?=$row_get_nap_P[nilaiangka]?></span></font><br></td>
		<?
		} else {
		?>
			<td height="25" align="center"><span class="style13"><?=$row_get_nap_P[nilaiangka]?></span><br></td>
		<?
		}
	} else {
	?>
	...
	?>
    <td height="25" align="center"><span class="style13"><?=$row_get_nap_P[nilaihuruf]?></span></td>
    <td height="25" align="center"><span class="style13"><?=$predikat?></span></td>
  </tr>
	<?
		$cntpel_laporan++;
		}
...
<table width="100%" border="0">
  ...
  <tr height="20">
    <td width="15%"><span class="style13"><strong>Sekolah</strong></span></td>
