...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="18%" colspan="3" class="headerlong"><div align="center">Nilai Pemahaman Konsep</div></td>
    <td width="19%" colspan="3" class="headerlong"><div align="center">Nilai Praktik</div></td>
  ...
  <tr>
    ...
    <td class="header" align="center">Terbilang</td>
    <td class="header"><div align="center">Angka</div></td>
    <td class="header"><div align="center">Huruf</div></td>
    <td class="header" align="center">Terbilang</td>
    </tr>
	...
	while ($row_get_pelajaran_laporan=@mysql_fetch_array($result_get_pelajaran_laporan)){
		...
		$num_get_nap_PK=@mysql_num_rows($result_get_nap_PK);
		...
		$num_get_nap_P=@mysql_num_rows($result_get_nap_P);
  ...
  <tr>
	...
	<td align="center"><?=$NTT->Convert($row_get_nap_PK[nilaiangka])?></td>
	<?
	if ((int)$row_get_nap_P[nilaiangka]!=0){
		if ($row_get_nap_P[nilaiangka]<$row_get_infonap[nilaimin]){ //Biar ada merahnya
		?>
    ...
    <td align="center"><?=$NTT->Convert($row_get_nap_P[nilaiangka])?></td>
