...
<tr>
    ...
    <?
	$sql_cek_ujian = "SELECT u.replid, u.tanggal, u.deskripsi, r.rpp FROM jbsakad.ujian u, jbsakad.rpp r WHERE u.idaturan=$idaturan AND u.idkelas=$kelas AND u.idsemester=$semester AND u.idrpp = r.replid ORDER by u.tanggal ASC";
  ...
  <?
    ...
    ?>
			<td align="center" bgcolor="#FFFFFF"><?=round(($nilaiujian[$j]/$jumsiswa),2)?></td>
	<? 	} ?>
