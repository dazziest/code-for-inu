...
<table width="100%" border="0" >
 <tr>
    ...
    <td width="41%"><strong><input type="text" name="nis" id="nis" size="25"  readonly class="disabled" value="<?=$nis ?>" onclick="carisiswa()" />
    </strong></td>
    <td width="32%" rowspan="2" valign="bottom"><a href="JavaScript:carisiswa()" onmouseover="showhint('Cari Siswa!', this, event, '50px')"><img src="../images/ico/lihat.png" border="0"/></a></td>
 </tr>
<tr>
