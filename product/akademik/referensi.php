...
<table id="Table_01" width="491" height="434" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td colspan="3" rowspan="2">
			<a href="referensi/departemen.php" onMouseOver="showhint('Pendataan Sekolah', this, event, '100px')"><img src="images_slice/referensi_09.jpg" width="78" height="71" alt="" border="0"></a></td>
		<td colspan="2" rowspan="3">
