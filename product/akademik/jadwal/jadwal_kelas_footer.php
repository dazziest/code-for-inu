...
function tambah(jam, hari) {
	...
	newWindow('jadwal_kelas_add.php?departemen='+departemen+'&kelas='+kelas+'&info='+info+'&maxJam='+maxJam+'&jam='+jam+'&hari='+hari, 'TambahJadwalKelas', '500', '455', 'resizable=1,scrollbars=1,status=0,toolbar=0');
}
...
function edit(replid) {
	...
	newWindow('jadwal_kelas_edit.php?maxJam='+maxJam+'&replid='+replid, 'UbahJadwalKelas','500','455','resizable=1,scrollbars=1,status=0,toolbar=0')
...
function cetak() {
	...
	newWindow('jadwal_kelas_cetak.php?departemen='+departemen+'&kelas='+kelas+'&info='+info, 'CetakJadwalKelas', '800', '650', 'resizable=1,scrollbars=1,status=0,toolbar=0');
}
    ...
    <table width="100%" border="0" align="center">
  	<tr>
   	...
   	<? if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
	    <a title="Hapus" href="JavaScript:hapus(<?=$kelas ?>, 1)">
        <img src="../images/ico/hapus.png" border="0" onMouseOver="showhint('Hapus Jadwal!', this, event, '90px')"/>&nbsp;Hapus Jadwal Kelas Ini</a>&nbsp;&nbsp;
	<? } ?>  
...
<? 		} else { ?> 
	...
	<tr>
    	...
    	<font size = "2" color ="red"><b>Belum ada data Jam Belajar untuk Sekolah <?=$departemen?>. 
...
?> 	
	...
	<tr>
		<td align="center" valign="middle" height="200">
    	<font size = "2" color ="red"><b>Tidak ditemukan adanya data jadwal mengajar. <br /><br />Tambah data pelajaran pada sekolah <?=$departemen?> dan guru yang akan mengajar<br> di menu Pendataan Guru pada bagian Guru & Pelajaran.</b></font>
		</td>
	</tr>
	</table>
<? } ?>     
