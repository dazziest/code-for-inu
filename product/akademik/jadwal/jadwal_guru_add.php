...
if (isset($_REQUEST['Simpan'])) {			
	...
	//$sql3 = "SELECT * FROM jadwal WHERE nipguru = '$nip' AND hari = $hari AND jam1 < '$jm2' AND jam2 > '$jm1'";
	$sql3 = "SELECT * FROM jadwal WHERE departemen = '$departemen' AND infojadwal = $info AND hari = $hari AND nipguru = '$nipguru' AND jamke BETWEEN '$jam' AND '$jam2'";
	$result3 = QueryDb($sql3);
		
	//$sql4 = "SELECT * FROM jadwal WHERE idkelas = '$kelas' AND hari = $hari AND jam2 > '$jm1'";
	$sql4 = "SELECT * FROM jadwal WHERE departemen = '$departemen' AND infojadwal = $info AND idkelas = '$kelas' AND hari = $hari AND jamke BETWEEN '$jam' AND '$jam2'";
...
<title>Akademik [Tambah Jadwal Guru]</title>
...
<tr>
	<td width="30%"><strong>Sekolah</strong></td>
