...
function tampil(){
	...
	if (nip==""){
		...
		parent.footer.location.href="jadwal_guru_footer.php?info="+info_jadwal+"&nip="+nip+"&departemen="+departemen+"&tahunajaran="+tahunajaran;
	}
}
...
<tr>
    ...
    <tr>
    	...
    	<input type="text" name="nama" id="nama" size="30" class="disabled" value="<?=$_REQUEST['nama'] ?>" readonly onClick="pegawai()">
    ...
    <tr>
   	...
   	<tr>
        ...
        <td colspan="3"><select name="info_jadwal" id="info_jadwal" onChange="change(0)" style="width:285px" onkeypress="return focusNext('tabel', event)">
          <? 	OpenDb();
