...
sendRequestText("mutasi_cari_siswa.php", show_panel0, "");
...
function departemen2() {
	...
	sendRequestText("mutasi_get_kelas_pilih.php", show_kelas, "departemen="+departemen2);
	parent.mutasi_content.location.href="daftar_mutasi_siswa_footer.php?from_left=1&departemen="+departemen2;
}
function departemen() {
	//var departemen2=document.getElementById("departemen2").value;	
	sendRequestText("mutasi_get_blank.php", show_blank_cari, "");
}
