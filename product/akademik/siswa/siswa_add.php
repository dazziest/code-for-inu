...
/*OpenDb();
$sql_sklh="SELECT sekolah,departemen FROM jbsakad.asalsekolah WHERE sekolah='$row_siswa[asalsekolah]'";
$result_sklh=QueryDB($sql_sklh);
while ($row_sklh = mysql_fetch_array($result_sklh)) {
	$dept=$row_sklh['departemen'];
}*/
?>
...
<title>AKADEMIK [Tambah Data Siswa]</title>
...
<tr height="150">
    ...
    <input type="hidden" name="departemen" value="<?=$departemen?>">
  	...
  	<tr>
        ...
        <font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Data Pribadi Siswa</strong></font>
	...
	// Akhir Olah Data angkatan
  	...
  	<tr>
    	...
    	<td colspan="2">
        <input type="text" name="nis" id="nis" size="20" maxlength="20" class="ukuran" value="<?=$nis?>"  onKeyPress="return focusNext('nama', event)" onFocus="showhint('NIS Siswa tidak boleh kosong!', this, event, '120px');panggil('nis')" onBlur="unfokus('nis')"/>        </td>
  	</tr>
 	<tr>
	...
	<tr>
  	...
  	<tr>
    	...
    	<td colspan="2">
        	<textarea name="ketsekolah" cols="30" rows="2" id="ketsekolah" onFocus="showhint('Keterangan sekolah asal tidak boleh lebih dari 255 karakter!', this, event, '120px');panggil('ketsekolah')" class="Ukuranketerangan" onKeyPress="return focusNext('gol', event)" onBlur="unfokus('ketsekolah')"><?=$ketsekolah?></textarea>
     	</td>
  	</tr>
	</table>    
	<script language='JavaScript'>
    ...
    <table width="100%" border="0" cellspacing="0" id="table" >
  	<tr>
        ...
        <font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Riwayat Kesehatan</strong></font>
    ...
    <tr>
  	...
  	<tr>
    	<td height="30" colspan="3">
        <font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Data Orang Tua Siswa</strong></font>
		<hr width="375" style="line-height:1px; border-style:dashed" align="left" color="#000000"/>        </td>
    </tr>
  	<tr>
    	<td>&nbsp;</td>
    ...
    -->
  	<tr>
    	<td height="30" colspan="3">
        <font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Data Lainnya</strong></font>
	    <hr width="375" style="line-height:1px; border-style:dashed" align="left" color="#000000"/>        </td>
    </tr>
  	<tr>
