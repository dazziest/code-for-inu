...
function change_departemen() {
	...
	parent.alumni_header.location.href = "alumni_header.php?departemen="+departemen;
	parent.alumni_footer.location.href = "blank_alumni_all.php";
}
...
function change_tingkat() {
	...
	parent.alumni_header.location.href = "alumni_header.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;
	parent.alumni_footer.location.href = "blank_alumni_all.php";
}
...
function tampil() {
	...
	parent.alumni_footer.location.href = "alumni_footer.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;	
}
...
<tr>
	...
	?>
  	...
  	<td valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" height="48" border="0" name="tabel" id="tabel" onmouseover="showhint('Klik untuk menampilkan daftar siswa yang menjadi alumnus!', this, event, '200px')"/></a></td>
  	<td colspan = "2" align="right" valign="top">        
     <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Pendataan Alumni</font><br />
      <a href="../kelulusan.php" target="content">
      <font size="1" color="#000000"><b>Kenaikan & Kelulusan</b></font></a>&nbsp>&nbsp
      <font size="1" color="#000000"><b>Pendataan Alumni</b></font>
    </td>     
</tr>
</table>
