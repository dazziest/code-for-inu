...
if ($iddasar!="12"){
	...
	for ($i=1;$i<=$jum;$i++) {	
		...
		if ($departemen<>"-1" && $idangkatan>0) {	
			$query1 = "SELECT COUNT(*) As Jum$field FROM jbsakad.siswa s, jbsakad.angkatan a WHERE s.idangkatan=$idangkatan AND a.replid=s.idangkatan AND a.departemen='$departemen' AND s.aktif = $filter ";
		}
	...
	$query1 = "SELECT COUNT(*) As Jum FROM jbsakad.siswa s, jbsakad.angkatan a WHERE a.replid=s.idangkatan  AND s.aktif = '1' AND s.penghasilanayah+s.penghasilanibu <> 0 AND s.penghasilanayah+s.penghasilanibu<1000000 $kondisi";
	
	$query2 = "SELECT COUNT(*) As Jum FROM jbsakad.siswa s, jbsakad.angkatan a WHERE a.replid=s.idangkatan  AND s.aktif = '1' AND s.penghasilanayah+s.penghasilanibu>=1000000 AND s.penghasilanayah+s.penghasilanibu<2500000 $kondisi";
	
	$query3 = "SELECT COUNT(*) As Jum FROM jbsakad.siswa s, jbsakad.angkatan a WHERE a.replid=s.idangkatan  AND s.aktif = '1' AND s.penghasilanayah+s.penghasilanibu>=2500000 AND s.penghasilanayah+s.penghasilanibu<5000000 $kondisi";
	
	$query4 = "SELECT COUNT(*) As Jum FROM jbsakad.siswa s, jbsakad.angkatan a WHERE a.replid=s.idangkatan  AND s.aktif = '1' AND s.penghasilanayah+s.penghasilanibu>=5000000 $kondisi";
...
<title>Akademik [Cetak Statistik Data Siswa]</title>
...
<table width="780" border="0" >
  ...
  <tr height="50" valign="top">
    <th colspan="2" scope="row"><div align="center" class="style1">Statistik Kesiswaan Berdasarkan <?=$dasar?></div></th>
    </tr>
  <tr>
    <th width="12%" scope="row"><div align="left">Sekolah</div></th>
    <td><div align="left">: 
      <?=$dep?>
    </div></td>
  </tr>
  <tr>
    <th scope="row"><div align="left">Angkatan</div></th>
    <td><div align="left">: 
      <?=$pros?>
    </div></td>
  </tr>
  ...
  <tr>
    <td><div align="center" id="batang"><img src="statistik_batang.php?iddasar=<?=$iddasar?>&departemen=<?=$departemen?>&idangkatan=<?=$idangkatan?>"/></div></td>
  </tr>
  <tr>
    <td>    </td>
  </tr>
  ...
  <tr>
    <td><div align="center" id="pie"><img src="statistik_pie.php?iddasar=<?=$iddasar?>&departemen=<?=$departemen?>&idangkatan=<?=$idangkatan?>"  height="300" width="449"/></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
