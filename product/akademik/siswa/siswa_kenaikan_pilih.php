...
if ($op=="x2378e23dkofh73n25ki9234"){
	...
	if ((int)$kap_kelas_tujuan <= (int)$row_jum_kelas_tujuan[0]){
		...
		if ($success){
			$sql_naik_kelas_insert="INSERT INTO jbsakad.riwayatkelassiswa SET idkelas=$kelastujuan, aktif=1, nis='$nisdipindah' ,mulai='$sekarang',status=1,keterangan='$ket'";
			QueryDbTrans($sql_nsaik_kelas_insert, $success);
		}
		...
		if ($success){
			...
			parent.siswa_kenaikan_tujuan.location.href = "siswa_kenaikan_tujuan.php?kelas=<?=$kelastujuan?>&departemen=<?=$departemen?>&tingkatawal=<?=$tingkatawal?>&tahunajaranawal=<?=$tahunajaranawal?>&pilihan=<?=$pilihan?>";
			document.location.href = "siswa_kenaikan_pilih.php?kelas=<?=$kelas?>&departemen=<?=$departemen?>&tingkat=<?=$tingkat?>&tahunajaran=<?=$tahunajaran?>&tahunajaran=<?=$tahunajaran?>&namadicari=<?=$namadicari?>&nisdicari=<?=$nisdicari?>&pilihan=<?=$pilihan?>";
			</script>
			<? 
		} else {
			RollbackTrans();
...
function pindah_siswa(nis,idkelas, i) {
	...
	//var ket = document.getElementById("ket_"+nis).value;
	var tingkattujuan = parent.siswa_kenaikan_tujuan.document.kanan.tingkat.value;
	var tahunajarantujuan = parent.siswa_kenaikan_tujuan.document.kanan.tahunajaran.value;
	//var tingkatawal = parent.siswa_kenaikan_tujuan.document.kanan.tingkatawal.value;
	//var tahunajaranawal = parent.siswa_kenaikan_tujuan.document.kanan.tahunajaranawal.value;
	var kelastujuan = parent.siswa_kenaikan_tujuan.document.kanan.kelas.value;
...
function setfirstpage(){
	...
	var namadicari=document.getElementById("namadicari").value;
	var jenis=document.getElementById("jenis").value;
	document.location.href="siswa_kenaikan_pilih.php?tingkat="+tingkat+"&tahunajaran="+tahunajaran+"&nisdicari="+nisdicari+"&namadicari="+namadicari+"&departemen="+departemen+"&kelas="+kelas+"&urut="+urut+"&urutan="+urutan+"&jenis="+jenis+"&page=0&hal=0&varbaris=5";
}
...
function change_page(page) {
	...
	document.location.href = "siswa_kenaikan_pilih.php?tingkat="+tingkat+"&tahunajaran="+tahunajaran+"&nisdicari="+nisdicari+"&namadicari="+namadicari+"&departemen="+departemen+"&kelas="+kelas+"&jenis="+jenis+"&page="+page+"&urut=<?=$urut?>&urutan=<?=$urutan?>&varbaris="+varbaris+"&hal="+page;
}
...
function change_hal() {
	...
	document.location.href="siswa_kenaikan_pilih.php?tingkat="+tingkat+"&tahunajaran="+tahunajaran+"&nisdicari="+nisdicari+"&namadicari="+namadicari+"&departemen="+departemen+"&kelas="+kelas+"&jenis="+jenis+"&page="+hal+"&hal="+hal+"&urut=<?=$urut?>&urutan=<?=$urutan?>&varbaris="+varbaris;
}
...
function change_baris() {
	...
	document.location.href= "siswa_kenaikan_pilih.php?tingkat="+tingkat+"&tahunajaran="+tahunajaran+"&nisdicari="+nisdicari+"&namadicari="+namadicari+"&departemen="+departemen+"&kelas="+kelas+"&jenis="+jenis+"&urut=<?=$urut?>&urutan=<?=$urutan?>&varbaris="+varbaris;
}
...
function refresh_pilih(i) {
	...
	document.location.href="siswa_kenaikan_pilih.php?tingkat="+tingkat+"&tahunajaran="+tahunajaran+"&nisdicari="+nisdicari+"&namadicari="+namadicari+"&departemen="+departemen+"&kelas="+kelas+"&urut=<?=$urut?>&urutan=<?=$urutan?>&jenis="+jenis+"&page=<?=$page?>&hal=<?=$hal?>&varbaris=<?=$varbaris?>&count="+i+"&ket="+ket;
}
</script>
</head>
<body topmargin="0" leftmargin="0">
<form name="pilih" id="pilih" method="post">
