...
function change_departemen() {
	...
	document.location.href = "siswa_tidak_naik_header.php?departemen="+departemen;
	parent.siswa_tidak_naik_footer.location.href="blank_tidaknaik_all.php";
}
...
function change_tingkat() {
	...
	parent.siswa_tidak_naik_header.location.href = "siswa_tidak_naik_header.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;
	parent.siswa_tidak_naik_footer.location.href = "blank_kenaikan_all.php";
}
...
function cari_siswa() {
	...
	parent.siswa_tidak_naik_footer.location.href = "siswa_tidak_naik_footer.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;	
