...
if (isset($_REQUEST['Simpan'])){
	OpenDb();	
	$sql_cek = "SELECT k.kapasitas, COUNT(s.replid) FROM kelas k, siswa s WHERE k.replid = $kelas AND s.idkelas = k.replid AND k.replid <> $_REQUEST[kelas_lama] AND s.aktif = 1 GROUP BY kelas"; 
	...
	*/
	...
	if ($kapasitas == $isi && $_REQUEST[kelas_lama]!=$kelas) {
		...
		if ($num_cek_nis==0){
			...
			if ($success){
			$sql_dept="UPDATE jbsakad.riwayatdeptsiswa SET nis='$nis',departemen='$departemen',mulai='$kumplit' WHERE nis='$nis'";
			QueryDbTrans($sql_dept,$success);
			}
			//	QueryDbTrans($sql_dept,$success);
				
			if ($success){
			$sql_kls="UPDATE jbsakad.riwayatkelassiswa SET nis='$nis',idkelas=$kelas,mulai='$kumplit' WHERE nis='$nis' AND idkelas='$kelas_lama'";
...
<title>AKADEMIK [Ubah Data Siswa]</title>
...
<tr>
	...
	<tr>
		<td valign="top">
  		...
  		<tr valign="top">
    		<td width="18%"><strong>Sekolah</strong></td>
    		<td width="*" colspan="2">
    ...
    <br />
  	...
  	<tr>
        ...
        <table width="100%" border="0" cellspacing="0">
  		<tr>
    		<td colspan="3" height="30"><font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Data Pribadi Siswa</font>
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="text" name="nis" id="nis" size="20" maxlength="20" value="<?=$row_siswa['nis']?>"  onKeyPress="return focusNext('nama', event)" onFocus="showhint('NIS Siswa tidak boleh kosong!', this, event, '120px');panggil('nis')"  onblur="unfokus('nis')"/><input type="hidden" name="nis_lama" value="<?=$row_siswa['nis']?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2"><textarea name="ketsekolah" cols="30" rows="2" id="ketsekolah" onFocus="showhint('Keterangan sekolah asal tidak boleh lebih dari 255 karakter!', this, event, '120px');panggil('ketsekolah')" class="Ukuranketerangan" onKeyPress="return focusNext('gol', event)" onBlur="unfokus('ketsekolah')"><?=$row_siswa['ketsekolah']?></textarea>
            </td>
        </tr>
        </table>    
        <script language='JavaScript'>
        ...
        <td width="1%" align="center" valign="middle"><img src="../images/batas.png" width="1" height="620" /></td>
        <td width="*" valign="top"><!-- Kolom Kanan-->
        <table width="100%" border="0" cellspacing="0" id="table">
        <tr>
            <td colspan="3" height="30" valign="top">
            <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Riwayat Kesehatan</font>
            <hr width="375" style="line-height:1px; border-style:dashed" align="left" color="#000000"/>            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Data Orang Tua</font>
            <hr width="375" style="line-height:1px; border-style:dashed" align="left" color="#000000"/>            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="3" height="30">
            <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Data Lainnya</font>
            <hr width="375" style="line-height:1px; border-style:dashed" align="left" color="#000000" />            </td>
        </tr>
        <tr>
