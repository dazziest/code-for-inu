...
for ($i=1;$i<=$jum;$i++) {	
	...
	if ($departemen<>"-1" && $angkatan>0) {	
		$query1 = "SELECT COUNT(*) As Jum$field FROM jbsakad.siswa s, jbsakad.angkatan a WHERE s.idangkatan=$angkatan AND a.replid=s.idangkatan AND a.departemen='$departemen' AND s.aktif = $filter ";
	}
