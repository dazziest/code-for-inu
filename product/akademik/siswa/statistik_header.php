...
<tr>
    ...
    <table width = "98%" border = "0" cellpadding="0" cellspacing="0">
 	<tr>
    	<td align="left" width = "35%"><strong>Sekolah</strong>
    	<td width = "*">
    ...
    <tr>
   	...
   	<td width="5%" rowspan="2" valign="middle"><a href="#" onclick="tampil_statistik()" ><img src="../images/view.png" height="48" border="0" name="tabel" id="tabel" onmouseover="showhint('Klik untuk menampilkan statistik !', this, event, '120px')"/></a></td>
