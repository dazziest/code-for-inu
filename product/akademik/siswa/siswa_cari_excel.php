...
OpenDb();
$sql = "SELECT s.replid,s.nis,s.nama,s.asalsekolah,s.tmplahir,DATE_FORMAT(s.tgllahir,'%d %M %Y') as tgllahir,s.status,t.tingkat,k.kelas,s.aktif from jbsakad.siswa s, jbsakad.kelas k, jbsakad.tingkat t WHERE s.".$jenis." LIKE '%$cari%' AND k.replid=s.idkelas AND k.idtingkat=t.replid AND t.departemen='$departemen' ORDER BY $urut $urutan";
$result=QueryDb($sql);
...
<table width="700" border="0">
  ...
  <tr>
	<td colspan="7"><strong>Sekolah :&nbsp;<?=$departemen?></strong></td>
  </tr>
  <tr>
