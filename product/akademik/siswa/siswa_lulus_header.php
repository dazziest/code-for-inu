...
function change_departemen() {
	...
	parent.siswa_lulus_header.location.href = "siswa_lulus_header.php?departemen="+departemen;
	parent.siswa_lulus_footer.location.href = "blank_lulus_all.php";
}
...
function change_tingkat() {
	...
	parent.siswa_lulus_header.location.href = "siswa_lulus_header.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;
	parent.siswa_lulus_footer.location.href = "blank_lulus_all.php";
}
...
function tampil() {
	...
	parent.siswa_lulus_footer.location.href = "siswa_lulus_footer.php?departemen="+departemen+"&tingkat="+tingkat+"&tahunajaran="+tahunajaran;	
}
...
<tr>
    ...
    <tr>
      	<td width = "30%"><strong>Sekolah</strong>
      	<td width = "*">
	...
	?>
  	...
  	<td valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" height="48" border="0" name="tabel" id="tabel" onmouseover="showhint('Klik untuk menampilkan daftar siswa yang akan diluluskan!', this, event, '200px')"/></a></td>
  	<td colspan = "2" align="right" valign="top"><font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Kelulusan</font><br />
    <a href="../kelulusan.php" target="content">
      <font size="1" color="#000000"><b>Kenaikan & Kelulusan</b></font></a>&nbsp>&nbsp
        <font size="1" color="#000000"><b>Kelulusan</b></font>
    </td>     
</tr>
</table>
