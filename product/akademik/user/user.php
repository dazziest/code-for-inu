...
<?	} ?>    
    ...
    <tr height="30" class="header" align="center">
        ...
        <td width="12%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" onClick="change_urut('departemen','<?=$urutan?>')" style="cursor:pointer;">Sekolah <?=change_urut('departemen',$urut,$urutan)?></td>
