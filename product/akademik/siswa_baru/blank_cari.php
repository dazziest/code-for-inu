...
<body>
<table border="0" width="100%" align="center" background="../images/ico/b_carisiswa.png" style="background-repeat:no-repeat">
<!-- TABLE CENTER -->
<tr height="300">
	<!--<td align="left" valign="top" background="../images/ico/b_calonsiswa.png" style="background-repeat:no-repeat">-->
    <td>
