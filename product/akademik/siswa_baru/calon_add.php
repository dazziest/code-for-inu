...
<tr height="150">
    ...
    <tr>
        ...
        <tr>
        	<td height="30" colspan="3"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Data Pribadi Calon Siswa</strong></font>
          	<hr width="300" style="line-height:1px; border-style:dashed" align="left" color="#000000" />            </td>
        </tr>
        <tr>
    ...
    <? // Olah untuk combo sekolah
        ...
        <tr>
            ...
            Sekolah </td>
          	<td colspan="2"><textarea name="ketsekolah" id="ketsekolah" rows="2" cols="30"  class="Ukuranketerangan" onfocus="showhint('Keterangan sekolah asal tidak boleh lebih dari 255 karakter!', this, event, '120px');panggil('ketsekolah')" onkeypress="return focusNext('gol', event)" onblur="unfokus('ketsekolah')"><?=$ketsekolah?>
          	</textarea></td>
        </tr>
      	</table>
        <script language='JavaScript'>
	    //Tables('table', 1, 0);
      	...
      	<img src="../images/batas.png" width="1" height="580" /></td>
      	<td width="*" valign="top"><!-- Kolom Kanan-->
        <table width="100%" border="0" cellspacing="0" id="table">
    	<tr>
         	<td height="30" colspan="3" valign="top"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Riwayat Kesehatan</strong></font>
        ...
        <tr>
            ...
            <hr width="375" style="line-height:1px; border-style:dashed" align="left" />            </td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
       ...
       <tr>
        ...
        <tr>
          	...
          	<td colspan="2">
            <textarea name="keterangan" id="keterangan" rows="2" cols="30" class="Ukuranketerangan" onKeyPress="return focusNext('Simpan', event)" onfocus="panggil('keterangan')" onblur="unfokus('keterangan')"><?=$keterangan?></textarea></td>
        </tr>
      	</table>
        <script language='JavaScript'>
	    //Tables('table', 1, 0);
...
var sprytextfield16 = new Spry.Widget.ValidationTextField("penghasilanayah1");
var sprytextfield17 = new Spry.Widget.ValidationTextField("penghasilanibu1");
