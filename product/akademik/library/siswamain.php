...
sendRequestText("cari_siswa.php", show_panel0, "");
sendRequestText("pilih_siswa.php", show_panel1, "");
...
function cari(){
	...
	sendRequestText("get_siswa_cari.php", show_tabelcari, "departemen="+departemen+"&nis="+nis+"&nama="+nama);
...
function show_kelas(x) {
	...
	sendRequestText("get_siswa_pilih.php", show_tabelpilih, "kelas="+kelas);
...
function kelas() {
	...
	sendRequestText("get_siswa_pilih.php", show_tabelpilih, "kelas="+kelas+"&alumni=1");
