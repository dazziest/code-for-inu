...
<tr>
    <td width="9%"><font color="#000000"><strong>Sekolah </strong></font><br /></td>
...
<tr>
	...
	<? } else { ?>    		
        ...
        <? 	if ($pelajaran == -1 || strlen($pelajaran) == 0) { ?>
			...
			Tambah data guru pada sekolah <?=$departemen?> di menu Pendataan Guru pada bagian Guru & Pelajaran. </b></font>	
		...
		?> 		
        Tambah data guru yang akan mengajar pelajaran <?=$row['nama']?> pada sekolah <?=$departemen?> di menu Pendataan Guru pada bagian Guru & Pelajaran. </b></font>
        <? } ?>
        <br /><br />        	</td>
        </tr>
        </table>
