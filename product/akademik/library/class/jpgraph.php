...
class Graph {
    ...
    public $plotarea_color=array(183,217,226);	// Plot area color
...
// PUBLIC METHODS	
    ...
    function Set3DPerspective($aDir=1,$aHorizon=100,$aSkewDist=120,$aQuality=false,$aFillColor='#000000',$aBorder=false,$aMinSize=true,$aHorizonPos=0.5) {
	$this->iImgTrans = true;
...
// PUBLIC METHODS	
    ...
    function SetBox($aFrameColor=array(183,217,226),$aBorderColor=array(0,0,0),$aShadowColor=false,$aCornerRadius=4,$aShadowWidth=3) {
