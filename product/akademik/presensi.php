...
<div id="menu" align="left" style="background-image:url(images/bgtab.png)"><img src="images/pp.png" border="0" usemap="#Map" id="img" />
  <map name="Map" id="Map">
    <area shape="rect" coords="18,13,98,45" href="#" onmouseover="over('ph')" onmouseout="out('ph')" onclick="show('ph')" />
    <area shape="rect" coords="101,14,180,46" href="#" onmouseover="over('pp')" onmouseout="out('pp')" onclick="show('pp')" />
  </map>
</div>
