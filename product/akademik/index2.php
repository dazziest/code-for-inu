...
<frameset rows="120,*,50" frameborder="0" border="0" framespacing="0">
	<frameset cols="50,*,40" frameborder="0" framespacing="0">
        ...
        <frame name="topcenter" id="topcenter" src="topcenter.php?theme=<?=$theme?>" scrolling="no" noresize  />
    ...
    <frameset cols="50,*,40" frameborder="0" framespacing="0">
        ...
        <frame name="content" id="content" src="referensi.php?theme=<?=$theme?>" scrolling="auto"  noresize/>
	...
	<frameset cols="50,*,40" frameborder="0" framespacing="0">
        ...
        <frame id="bottomcenter" name="bottomcenter" src="bottomcenter.php?theme=<?=$theme?>" scrolling="no" noresize  />
